...
- **Boxplot of Ticket Prices (Outliers)**  
  ![Boxplot of Ticket Prices](images/price_boxplot.png)

- **Delay Distribution**  
  ![Delay Distribution](images/delay_distribution.png)

- **Journey Duration Distribution**  
  ![Journey Duration](images/journey_duration.png)
...
- **Revenue by Departure Station**  
  ![Revenue by Station](images/revenue_by_station.png)
...
- **Ticket Type Distribution**  
  ![Ticket Type Distribution](images/ticket_type_pie.png)

- **Reasons for Delay**  
  ![Reasons for Delay](images/delay_reasons.png)
...
- **Daily Ticket Purchases Trend**  
  ![Daily Purchases](images/daily_purchases_trend.png)
